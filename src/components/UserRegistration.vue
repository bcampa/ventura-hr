      ...
      >
        <tr>
          <td width="100%" bgcolor="#808080">
            <font size="4" color="#FFFFFF"><b>VenturaHR (cabeçalho)</b></font>
          </td>
        </tr>
        <tr>
          <td width="100%">
                    ...
                    <center>
                      ...
                      >
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="razaoSocial" size="30" />
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td colspan="2">
                            <p align="center">
                              <input
                                type="button"
                                value="Criar Conta"
                                onclick="location.href='09_03_Tela_de_Ofertas_Candidato.html'"
                              />
                            </p>
                          </td>
                        </tr>
        ...
        <tr>
          <td width="100%" bgcolor="#808080">
            <font size="4" color="#FFFFFF"><b>(rodape)</b></font>
          </td>
        </tr>
      </table>
    </center>
