<template>
  <tr>
    <td valign="top">
      <p align="center">
        <font size="2"><b>Bem Vindo Machado de Assis!</b></font>
      </p>
      <table
        border="1"
        cellpadding="5"
      ...
      >
        ...
        <tr>
          <td width="50%" valign="top">
            ...
            <p>
              <font size="2"
                >Atenção: entre em contato com a administração para resolver
                pendências de pagamento</font
              >
            </p>
          </td>
          <td width="50%" valign="top">
        ...
        <tr>
          <td width="100%" colspan="2">
            <p align="center">
              <b><font size="2">Consulta de Vagas Disponíveis:</font></b>
            </p>
            <div align="center">
              <center>
                <table
                ...
                >
                  <tr>
                    <td>
                      <font size="2">com <b>todas</b> as palavras</font>
                    </td>
                    <td><input type="text" name="pesquisa_1" size="60" /></td>
                  </tr>
                  <tr>
                    <td>
                      <font size="2">com <b>qualquer uma</b> das palavras</font>
                    </td>
                  ...
                  <tr>
                    <td colspan="2">
                      <p align="center" style="margin-top: 0; margin-bottom: 0">
                        <font size="2"
                          ><b>34 Vagas encontradas</b>, exibindo de 1 a 5</font
                        >
                      </p>
                      <p align="center" style="margin-top: 0; margin-bottom: 0">
                        <font size="2"
                          >[<a href="a">Início</a> | <a href="a"> Anterior</a>]
                          <a href="a">1</a> <a href="a">2</a> <a href="a">3</a>
                          <a href="a">4</a> [<a href="a">Próxima</a> |
                          <a href="a">Fim</a>]</font
                        >
                      </p>
                      ...
                      >
                        ...
                        <tr>
                          ...
                          <td width="52%">
                            Aenean felis leo, sagittis ac, aliquam sed, mattis
                            eu, ligula.
                          </td>
